...
import JavaIcon from './programmingIcons/javaIcon'

const IntroComponent = ({ name, designation, socialNetworks, classes }) => {
  return (
    <Fragment>
      
      <div className="flex flex-col items-center justify-center w-screen h-screen  text-white intro">
        <div className="flex flex-col items-center justify-center space-y-2 intro-text">
          ...
          <div className="social-icons text-3xl text-white mt-6">
            <div>
              <a
